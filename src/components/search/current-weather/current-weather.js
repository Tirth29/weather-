const CurrentWeather = ({data}) => {
  return (
    <div className="weather w-80 border-spacing-2 rounded-xl text-white bg-slate-600 mr-20 mt-5 mb-auto ml-0">
      ...
      <div className="bottom flex justify-between items-center">
        <p className="temp font-semibold text-6xl w-auto mr-2">{Math.round(data.main.temp)-273}°C</p>
        ...
        <div className="parameter-row flex justify-between">
            ...
            <span className="par-v text-right font-semibold text-xs pr-7">{Math.round(data.main.feels_like)-273}°C</span>
        </div>
        <div className="parameter-row flex justify-between">
            <span className="par-l text-left font-normal text-xs">Wind</span>
            <span className="par-v text-right font-semibold text-xs pr-7">{data.wind.speed} m/s</span>
        </div>
        <div className="parameter-row flex justify-between">
            <span className="par-l text-left font-normal text-xs">Humidity</span>
            <span className="par-v text-right font-semibold text-xs pr-7">{data.main.humidity}%</span>
        </div>
        <div className="parameter-row flex justify-between">
            <span className="par-l text-left font-normal text-xs">Pressure</span>
            <span className="par-v text-right font-semibold text-xs pr-7">{data.main.pressure} hPa </span>
        </div>
